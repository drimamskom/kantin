...
<script type="text/javascript">  
	$(function(){ 
                ...
                $("#cbothn_ajaran").on("select2:select", function (e){ 
                    ...
                    if(ini==itu){
                        swal("warning","Tahun Pelajaran tidak boleh sama!","warning");
                ...
                $("#cbokelas2").on("select2:select", function (e){ 
                ...
                $(document).on("click","#btnnaikkan",function(){
                    ...
                    if(tot>0){
                        ...
                        if(tapel2.length==0){
                            ...
                            swal({   
                              title: "Naik Kelas?",   
                              text: "Apa anda yakin, Naik ke Kelas "+kelas2_text+" : "+tot+" Siswa?",   
                              type: "success",   
                              showCancelButton: true,   
                              confirmButtonColor: "#DD6B55",   
                              confirmButtonText: "Naik Kelas",   
                              closeOnConfirm: true }, 
                              function(){   
                                var value = { id:sel.join("-"), tipe:'naik', noww:noww, tapel:tapel, kelas:kelas, tapel2:tapel2, kelas2:kelas2 };
                                $.ajax({
                ...
                $(document).on("click","#btntinnggal",function(){
                    // Iterate over all checkboxes in the table
                    var tot=0;
                    var sel=[];
                    var table = $('#table_cust2').DataTable(); 
                    ...
                    if(tot>0){
                        ...
                        if(tapel.length==0){
                            ...
                            swal({   
                              title: "Tinggal Kelas?",   
                              text: "Apa anda yakin, Tinggal Kelas "+kelas_text+" : "+tot+" Siswa?",   
                              type: "success",   
                              showCancelButton: true,   
                              confirmButtonColor: "#DD6B55",   
                              confirmButtonText: "Tinggal Kelas",   
                              closeOnConfirm: true }, 
                              function(){   
                                var value = { id:sel.join("-"), noww:noww, tipe:'tinggal', tapel:tapel, kelas:kelas, tapel2:tapel2, kelas2:kelas2 };
                                $.ajax({
                                        url : "<?php echo base_url('siswa/naikturun_kelas'); ?>",
                                        type: "POST",
                                        data : value,
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <table width="100%">
                    ...
                    <td width="12%" align="center" valign="top" style="padding-top:97px;">            
                        <button type="button" class="btn btn-success" id="btnnaikkan" name="btnnaikkan">Naik Kelas <i class="fa fa-angle-double-right"></i></button>
                        <button type="button" class="btn btn-danger" id="btntinnggal" name="btntinnggal" style="margin-top:10px;"><i class="fa fa-angle-double-left"></i> Tinggal Kls</button>
                    </td>
                    <td width="44%" valign="top">          
                        <form id="formFilter2" class="form-horizontal">
                            <div class="col-sm-12" style="padding-left:0px"> <b>Naik Kelas Ke :</b>
                                <ul class="nav">
                                    <li>
                                        <div class="input-group">
                                            <div class="input-group-addon label-warning">Tapel</div>
