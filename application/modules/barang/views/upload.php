    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Upload Barang Baru</h3>
            </div>
            <div class="box-body">
                <?php echo @$pesan; ?>
                <?php echo form_open_multipart('barang/do_upload', array('class' => 'upload-form col-md-6')); ?>
                    <div class="form-group"> 
                        ...
                        <span id="infox2" class="help-block">
                            ...
                            Klik <a href="<?php echo base_url('assets/template/template_upload_barang_baru.xlsx');?>"><b><u>Disini</u></b></a> Untuk Download Template Uploadnya. 
                        </span>
                    </div>
                    <div class="form-group"> 
                        <a href="<?php echo base_url('barang') ?>" class="btn btn-warning"><i class="fa fa-angle-left"></i>&nbsp; Kembali</a>
