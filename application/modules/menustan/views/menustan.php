...
<script type="text/javascript">  
	$(function(){ 
		$('#table_cust').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?php echo base_url('menustan/data'); ?>",
                        "data": function( d ) {
		...
		$(document).on("click",".btnedit",function(){
                    ...
                    $.ajax({
                        url : "<?php echo base_url('menustan/cari'); ?>",
                        type: "POST",
                        data : { id:id },
                        dataType: "json",
		...
		$(document).on( "click",".btnhapus", function() {
                    ...
                    swal({   
                        ...
                        function(){   
                            var value = { id:id };
                            $.ajax({
                                url : "<?php echo base_url('menustan/hapus'); ?>",
                                type: "POST",
                                data : value,
                                dataType: "json",
		...
		$('#myform').on('submit', function(e) {
			e.preventDefault();
                        ...
                        $.ajax({
				url : "<?php echo base_url('menustan/save'); ?>",
				type: "POST",
				data : post_data,
				dataType: "json",
				success: function(data){
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li style="padding-left:10px;">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control selectpicker" name="stan" id="stan" data-width="150px" >
