...
<script type="text/javascript">   
	$(function(){ 
            $('#table_cust').DataTable({
                ...
                "serverSide": true,
	        "ajax": {
	            "url": "<?php echo base_url('lapdeposit/data'); ?>",
                    "data": function( d ) {
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Laporan Deposit</h3>
            </div>
            <div class="box-body"> 
                <form id="export_form" action="<?php echo base_url('lapdeposit/export'); ?>" method="post" target="_self">
                ...
                <table id="table_cust" width="100%" class="table table-bordered table-striped">
                    <thead class="label-primary">
                      <tr>
                            ...
                            <th style="width:10%">No. Deposit</th>
