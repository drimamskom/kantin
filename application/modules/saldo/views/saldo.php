...
<script type="text/javascript">  
	$(function(){ 
		$('#table_cust').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?php echo base_url('saldo/data'); ?>",
                        "data": function( d ) {
                ...
                $(document).on("click","#btnadd",function(){
                        ...
                        $("#crudmethod").val("N");
                        $("#txtid").val("");
                        $("#cbonis").val(null).trigger("change");
                        $("#txtnamasaldo").focus();
                });
		...
		$(document).on("click",".btnedit",function(){
                    ...
                    $.ajax({
                        url : "<?php echo base_url('saldo/cari'); ?>",
                        type: "POST",
                        data : { id:id },
                        dataType: "json",
                        success: function(result){
                                ...
                                $("#text_transfer").val("");
                                $("#crudmethod").val("E");
                                $("#txtid").val(data.no_pengisian);
                                $("#txtnamasaldo").val(data.nama_pengisian);
                                $("#tanggal").val(data.tanggal);
                                $("#cbonis").val(data.nis).trigger("change");
		...
		$(document).on( "click",".btnhapus", function() {
                    ...
                    swal({   
                        ...
                        function(){   
                            var value = { id:id };
                            $.ajax({
                                url : "<?php echo base_url('saldo/hapus'); ?>",
                                type: "POST",
                                data : value,
                                dataType: "json",
		...
		$('#myform').on('submit', function(e) {
			e.preventDefault();
                        ...
                        $.ajax({
				url : "<?php echo base_url('saldo/save'); ?>",
				type: "POST",
				data : post_data,
				dataType: "json",
				success: function(data){
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Master Saldo</h3>
            </div>
            <div class="box-body">
                    ...
                    <form id="formFilter" class="form-horizontal">
                        <div class="col-sm-9" style="padding-left:0px">
                            <ul class="nav nav-pills">
                                <li>
                                    <button type="button" class="btn btn-success" id="btnadd"><i class="fa fa-plus"></i>&nbsp;Tambah Saldo</button>
                                </li>
                ...
                <table id="table_cust" width="100%" class="table table-bordered table-striped">
                    <thead class="label-primary">
                      <tr>
                            ...
                            <th style="width:13%">Pengisian</th>
                            <th style="width:20%">Nama Pengisian</th>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Form Master Saldo <span id="text_transfer"></span></h4>
            </div>
            <div class="modal-body">
              <form id="myform" class="form-horizontal">
                    <div class="form-group"> 
                      <label class="col-sm-3 control-label">Nama Saldo</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="txtnamasaldo" name="namasaldo" placeholder="Nama Saldo" required/>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="cbonis" name="nis" style="width:100%" required>
                                <option value=""></option>
                                <?php
                    ...
                    <div class="form-group"> 
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control number-only" id="txtsaldo" name="saldo" placeholder="Saldo" required/>
                      </div>
                    </div>
                    <div class="form-group"> 
