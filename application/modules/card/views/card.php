...
<script type="text/javascript">   
	$(function(){ 
		...
		$('#table_cust').DataTable( {
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?php echo base_url('card/data'); ?>",
                        "dataType": "json",
                        "type": "POST"
                    },
                    "columnDefs": [
		...
		$('#myform').on('submit', function(e) {
			e.preventDefault();
                        ...
                        $.ajax({
                            url : "<?php echo base_url('card/save'); ?>",
                            type: "POST",
                            data : post_data,
                            dataType: "json",
		...
		$(document).on( "click",".btnhapus", function() {
                    ...
                    swal({   
                        ...
                        function(){   
                            var value = { id:id };
                            $.ajax({
                                url : "<?php echo base_url('card/hapus'); ?>",
                                type: "POST",
                                data : value,
                                dataType: "json",
                                success: function(data){
                ...
                $('#cbogrup').on("change", function (e) {
                    ...
                    if(akses=='customer'){
                        ...
                        $("#parentnama").show();
                        $.ajax({
                            url : "<?php echo base_url('card/info'); ?>",
                            type: "POST",
                            data : { kode:kode },
                            dataType: "json",
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Master Card</h3>
            </div>
            <div class="box-body">
                <p>
                <button type="submit" class="btn btn-primary " id="btnadd" name="btnadd"><i class="fa fa-plus"></i> Tambah Card</button>
                </p>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Form Master Card</h4>
            </div>
            <!--modal header-->
            <div class="modal-body">
              <form id="myform" class="form-horizontal">                  
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                            <select class="form-control select2" id="cbogrup" name="grup" style="width:100%" required>
                                <option value=""></option>
                                <?php
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            ...
                            <div id="parentkary"><input type="text" class="form-control" id="txtnama2" name="nama2" placeholder="Nama"/></div>
                        </div>
                    </div>
                    <div class="form-group"> 
                    ...
                    <div class="form-group"> 
                      ...
                      <div class="col-sm-9">
                              <input type="password" class="form-control" id="txtpin" name="pin" placeholder="PIN">
                            </div>
                    </div>
                    <div class="form-group"> 
