...
<script type="text/javascript">  
	$(function(){ 
		$('#table_cust').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?php echo base_url('returkantin/data'); ?>",
                        "data": function( d ) {
		...
		$('#myform').on('submit', function(e) {
			e.preventDefault();
                        ...
                        $.ajax({
				url : "<?php echo base_url('returkantin/save'); ?>",
				type: "POST",
				data : post_data,
				dataType: "json",
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Retur Stok Kantin Per Hari</h3>
            </div>
            <div class="box-body">
                ...
                <table id="table_cust" width="100%" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="9" style="padding-right:30px;">
