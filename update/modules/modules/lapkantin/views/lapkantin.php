...
<script type="text/javascript">   
	$(function(){ 
            $('#table_cust').DataTable({
                ...
                "serverSide": true,
	        "ajax": {
	            "url": "<?php echo base_url('lapkantin/data'); ?>",
                    "data": function( d ) {
            ...
            $(document).on( "click",".btnhapus", function() {
                    ...
                    swal({   
                        ...
                        function(){   
                            var value = { id:id };
                            $.ajax({
                                url : "<?php echo base_url('lapkantin/hapus'); ?>",
                                type: "POST",
                                data : value,
                                dataType: "json",
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Laporan Pemesanan Kantin</h3>
            </div>
            <div class="box-body"> 
                <form id="export_form" action="<?php echo base_url('lapkantin/export'); ?>" method="post" target="_self">
...
<form id="cetakform" action="<?php echo base_url('lapkantin/cetak'); ?>" method="post" target="_self">
