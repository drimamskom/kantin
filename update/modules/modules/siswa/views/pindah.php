                ...
                $(document).on("click","#btnpindah",function(){
                    ...
                    if(tot>0){
                        ...
                        if(tapel2.length==0){
                            ...
                            swal({   
                              title: "Pindah Kelas?",   
                              text: "Apa anda yakin, Pindah ke Kelas "+kelas2_text+" : "+tot+" Siswa?",   
                              type: "success",   
                              showCancelButton: true,   
                              confirmButtonColor: "#DD6B55",   
                              confirmButtonText: "Pindah Kelas",   
                              closeOnConfirm: true }, 
                              function(){   
                                var value = { id:sel.join("-"), tipe:'pindah', noww:noww, tapel:tapel, kelas:kelas, tapel2:tapel2, kelas2:kelas2 };
                                $.ajax({
                ...
                $(document).on("click","#btnpindah2",function(){
                    ...
                    if(tot>0){
                        ...
                        if(tapel.length==0){
                            ...
                            swal({   
                              title: "Pindah Kelas?",   
                              text: "Apa anda yakin, Pindah Ke Kelas "+kelas_text+" : "+tot+" Siswa?",   
                              type: "success",   
                              showCancelButton: true,   
                              confirmButtonColor: "#DD6B55",   
                              confirmButtonText: "Pindah Kelas",   
                              closeOnConfirm: true }, 
                              function(){   
                                var value = { id:sel.join("-"), noww:noww, tipe:'pindah2', tapel:tapel, kelas:kelas, tapel2:tapel2, kelas2:kelas2 };
                                $.ajax({
                                        url : "<?php echo base_url('siswa/naikturun_kelas'); ?>",
                                        type: "POST",
                                        data : value,
            ...
            <div class="box-body">
                <table width="100%">
                    ...
                    <td width="14%" align="center" valign="top" style="padding-top:97px;">            
                        <button type="button" class="btn btn-success" id="btnpindah" name="btnpindah">Pindah Kelas <i class="fa fa-angle-double-right"></i></button>
                        <button type="button" class="btn btn-danger" id="btnpindah2" name="btnpindah2" style="margin-top:10px;"><i class="fa fa-angle-double-left"></i> Pindah Kelas</button>
                    </td>
                    <td width="43%" valign="top">          
