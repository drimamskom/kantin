    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Upload Pelanggan Baru</h3>
            </div>
            <div class="box-body">
                <?php echo @$pesan; ?>
                <?php echo form_open_multipart('pelanggan/do_upload', array('class' => 'upload-form col-md-6')); ?>
                    <div class="form-group"> 
                        <label class="control-label">Data Pelanggan Baru</label>
                        ...
                        <span id="infox2" class="help-block">
                            ...
                            <a href="<?php echo base_url('assets/template/template_upload_pelanggan_baru.xlsx');?>"><u>Template Excel</u></a>
                        </span>
                    </div>
                    <div class="form-group"> 
                        <a href="<?php echo base_url('pelanggan') ?>" class="btn btn-warning"><i class="fa fa-angle-left"></i>&nbsp; Kembali</a>
